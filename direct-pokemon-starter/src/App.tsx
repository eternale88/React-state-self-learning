...
const PokemonDetail = () => {
  ...
  const { pokemon } = usePokemon()
  const singlePokemonData = pokemon.find((p) => p.id === parseInt(id))
    ...
    <div className="mt-3">
      ...
      <div className="grid grid-cols-2">
        <img
          ...
          src={`https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/pokemon/other/official-artwork/${singlePokemonData.id}.png`}
          alt=""
        />
        <div className="ml-3">
          <h2 className="text-2xl font-bold">{singlePokemonData.name}</h2>
          <div className="mt-3">
            ...
            <ul className="mt-3">
              {[
                ...
                <li key={stat} className="grid grid-cols-2">
                  ...
                  <span>
                    {singlePokemonData[stat as keyof typeof singlePokemonData]}
                  </span>
                </li>
              ))}
            </ul>
